...
uah_employee::uah_employee(string name, string email, string a_number, string salary) : uah_person (name, email, a_number)  // INHERITS UAH_PERSON ATTRIBUTES
{
...
// Prints all employee values including attribute of person
void uah_employee::print( ) const
{
  uah_person::print();
  cout << "Employee Salary: " << uah_employee::u_salary << endl;
}

// Added salary print to avoid duplicate prints for TA inheritence
void uah_employee::printSal() const {
  cout << "Employee Salary: " << uah_employee::u_salary << endl;
}
